...
function About() {
  return (<div>
    ...
    <div className="bg-gray-50 min-h-screen text-gray-800">
      ...
      {/* Header Section */}
      <header className="bg-cyan-600 text-white py-8 text-center">
      ...
      <section className="px-6 py-12 max-w-7xl mx-auto space-y-12">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-semibold text-cyan-600">What is the WellNessAI?</h2>
        ...
        <div className="space-y-6">
          <h2 className="text-3xl font-semibold text-cyan-600 text-center">How Does It Work?</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-xl font-semibold text-cyan-500">Step 1: Input Medical Data</h3>
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-xl font-semibold text-cyan-500">Step 2: Data Analysis</h3>
              <p className="mt-2 text-gray-600">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-xl font-semibold text-cyan-500">Step 3: Predictive Modeling</h3>
              <p className="mt-2 text-gray-600">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-xl font-semibold text-cyan-500">Step 4: Personalized Recommendations</h3>
              <p className="mt-2 text-gray-600">
        ...
        {/* Benefits Section */}
        <div className="bg-teal-50 py-12 text-center">
          <h2 className="text-3xl font-semibold text-cyan-600">Why Choose This WellNess AI</h2>
        ...
        <div className="space-y-6 text-center">
          <h2 className="text-3xl font-semibold text-cyan-600">Key Features</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-xl font-semibold text-cyan-500">Accurate Predictions</h3>
              <p className="mt-2 text-gray-600">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-xl font-semibold text-cyan-500">Personalized Health Advice</h3>
              <p className="mt-2 text-gray-600">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-xl font-semibold text-cyan-500">Easy to Use</h3>
              <p className="mt-2 text-gray-600">
      ...
      {/* Footer Section */}
      <footer className="bg-cyan-600 text-white py-8 text-center">
